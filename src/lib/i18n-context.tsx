...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    hero_desc: "Baccarat Rouge 540, Tom Ford, Creed, Dior — original va premium klon atirlar.",
  ...
  ru: {
    ...
    hero_desc: "Baccarat Rouge 540, Tom Ford, Creed, Dior — оригиналы и премиум-копии.",
