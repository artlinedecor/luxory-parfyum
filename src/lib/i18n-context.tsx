...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    stock_left: "ta qoldi",
    stock_in: "Omborda",
    stock_hot: "Tez tugaydi!",
    stock_order: "Buyurtma asosida",
    hotstock_title: "Omborda mavjud",
    hotstock_subtitle: "Cheklangan miqdorda — tez yetkazib beramiz",
    // Cart
  ...
  ru: {
    ...
    stock_left: "осталось",
    stock_in: "В наличии",
    stock_hot: "Скоро закончится!",
    stock_order: "Под заказ",
    hotstock_title: "В наличии на складе",
    hotstock_subtitle: "Ограниченное количество — быстрая доставка",
    // Cart
