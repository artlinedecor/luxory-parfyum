...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    login: "Kirish",
    // Home — Premium Hero
    hero_badge: "Brend atirlar · Toshkent",
    hero_title_1: "Sevimli atiringiz",
    hero_title_2: "bugunoq",
    hero_title_3: "bo'lib to'lashga",
    hero_desc: "Baccarat Rouge 540, Tom Ford, Creed, Dior va boshqa mashhur brendlar. Original va premium klon atirlar.",
    hero_delivery_badge: "3, 6 yoki 12 oyga bo'lib to'lash · O'zbekiston bo'ylab yetkazib berish",
    ...
    collection_title_1: "Barcha ",
    collection_title_2: "atirlar",
    collection_desc: "Original va premium klon atirlar — har birini 3, 6 yoki 12 oyga bo'lib to'lashga olish mumkin.",
    ...
    // Bo'lib to'lash bloki (Uzum Nasiya)
    nasiya_eyebrow: "Uzum Nasiya",
    nasiya_title_1: "Hoziroq oling —",
    nasiya_title_2: "keyin bo'lib to'lang",
    nasiya_desc: "Yoqqan atirni bugun buyurtma qiling, to'lovni 3, 6 yoki 12 oyga bo'lib to'lang. Karta ham, naqd pul ham kerak emas.",
    nasiya_point_1: "Faqat telefon raqam va SMS-kod",
    nasiya_point_2: "Shartnoma onlayn, 2 daqiqada",
    ...
    cart_success_title: "To'lov usulini tanlang",
    cart_success_desc: "Buyurtmani yakunlash uchun quyidagi usullardan biri orqali to'lovni amalga oshiring.",
  ...
  ru: {
    ...
    login: "Войти",
    // Home — Premium Hero
    hero_badge: "Брендовые ароматы · Ташкент",
    hero_title_1: "Любимый аромат",
    hero_title_2: "сегодня",
    hero_title_3: "в рассрочку",
    hero_desc: "Baccarat Rouge 540, Tom Ford, Creed, Dior и другие известные бренды. Оригиналы и премиум-копии.",
    hero_delivery_badge: "Рассрочка на 3, 6 или 12 месяцев · Доставка по Узбекистану",
    ...
    collection_title_1: "Все ",
    collection_title_2: "ароматы",
    collection_desc: "Оригиналы и премиум-копии — любой аромат можно оформить в рассрочку на 3, 6 или 12 месяцев.",
    ...
    nasiya_eyebrow: "Uzum Nasiya",
    nasiya_title_1: "Заберите сегодня —",
    nasiya_title_2: "платите частями",
    nasiya_desc: "Закажите аромат сегодня, а оплату разделите на 3, 6 или 12 месяцев. Ни карта, ни наличные не нужны.",
    nasiya_point_1: "Только номер телефона и SMS-код",
    nasiya_point_2: "Договор онлайн, за 2 минуты",
    ...
    cart_success_title: "Выберите способ оплаты",
    cart_success_desc: "Для завершения заказа выберите один из способов оплаты ниже.",
