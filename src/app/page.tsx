            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="text-center space-y-3 group">
                <div className="w-12 h-12 border border-border flex items-center justify-center mx-auto group-hover:border-gold transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 text-gold-dark">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
                  </svg>
                </div>
                <h3 className="font-heading text-lg text-foreground">{t("features_fast_title")}</h3>
              ...
              <div className="text-center space-y-3 group">
                ...
                <h3 className="font-heading text-lg text-foreground">{t("features_quality_title")}</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <div className="text-center space-y-3 group">
                ...
                <h3 className="font-heading text-lg text-foreground">{t("features_price_title")}</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <footer id="footer" className="py-14 px-4 sm:px-6 lg:px-8 border-t border-border bg-secondary/30">
          <div className="max-w-7xl mx-auto text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-4 text-[10px] text-muted-foreground/60">
              <Link href="/privacy-policy" className="hover:text-foreground transition-colors underline underline-offset-2">
