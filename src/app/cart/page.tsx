      ...
      <main className="flex-1 pt-24 pb-24 md:pb-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 space-y-6">
          ...
          <div className="space-y-3">
            {items.map((item) => (
              <div key={item.product.id} className="glass-card p-3 sm:p-4 flex gap-3 sm:gap-4 items-start animate-fade-in">
                ...
                <button onClick={() => removeItem(item.product.id)} aria-label="O'chirish" className="btn-icon w-11 shrink-0 border-transparent bg-transparent shadow-none hover:text-destructive">
